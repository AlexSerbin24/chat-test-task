...
export default function ChatMessage({ message,handleEditMessageBtnClick }: Props) {
    return (
        <div
            key={message.id}
            className={`message ${message.isUserMessage ? 'message-user' : 'message-bot'}`}
        >
            {!message.isUserMessage && <UserAvatar src={''} alt={''} />}
            ...
            <div className='message-body'>
                ...
                {message.isUserMessage
                    &&
                    <div className='edit-message-btn' onClick={()=>handleEditMessageBtnClick(message)}>
                        <svg fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494.936 494.936" width={20} height={20}>
                            <g strokeWidth="0"></g>
